 ...
 */
function theme_imtpn_atlantique_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @param $page
 */
function theme_imtpn_atlantique_page_init($page) {
